...
class mod_db{
	...
	function insert($tb_name,$cols,$val,$astriction){
		...
		$insert = mssql_query("INSERT INTO $tb_name $cols VALUES($val) $ast",$this->sql_link);
			if(!$insert){
				...
				echo "<script>alert('��Ʒs�W����');</script>"; // Chinese Error Message
	...
	function update($tb_name,$string,$astriction){
		...
		if(!$update){
			...
			echo "<script>alert('��Ƨ�s����');</script>"; // Chinese Error Message
	...
	function del($tb_name,$astriction){
		...
		if(!$del){
			...
			echo "<script>alert('��ƧR������');</script>"; // Chinese Error Message
	...
	function query($string){
		...
		if(!$this->query_id){
			...
			echo "<script>alert('�d�ߥ���');</script>"; // Chinese Error Message
	...
	function show_page_cut($string="",$num="",$url=""){
		...
		if(!$nowpage || $nowpage == "1"){
			$pagecut = "<font color = 'C0C0C0'>�Ĥ@��</font>";
		}else{
		...
		if(($nowpage-1) > 0){
			...
			$pagecut .=  "<font color = 'C0C0C0'>�e�@��</font>";
		}
			$pagecut .=  "&nbsp;&nbsp;";
		...
		$pagecut .=  "�ثe�b��&nbsp;";
		$pagecut .=  $i;
		$pagecut .=  "&nbsp;��<font color = '#663300'>/�@&nbsp;".$pages."&nbsp;��</font>";
		$pagecut .=  "&nbsp;&nbsp;";
		...
		if(($pages-$nowpage) > 0){
			...
			$pagecut .=  "<font color = 'C0C0C0'>�U�@��</font>";
		}
			$pagecut .=  "&nbsp;&nbsp;";

		###Last Page###
		if($nowpage == $pages){
			$pagecut .=  "<font color = 'C0C0C0'>�̫�@��</font>";
		}else{
